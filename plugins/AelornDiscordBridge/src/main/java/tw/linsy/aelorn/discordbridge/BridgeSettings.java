...
record BridgeSettings(
    ...
    boolean resourcePackAuditEnabled,
    String resourcePackSource,
    String resourcePackCopy,
    ...
    static BridgeSettings from(FileConfiguration config) {
        return new BridgeSettings(
            ...
            config.getBoolean("resource-pack.audit-enabled", true),
            config.getString("resource-pack.source", "").trim(),
            config.getString("resource-pack.addon-copy", "").trim(),
